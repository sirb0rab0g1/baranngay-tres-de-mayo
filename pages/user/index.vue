  ...
  export default {
    ...
    methods: {
      ...
      async getnotification (param) {
        ...
        // await axios.post('http://20.189.115.250/api/get-notification', {id: param ? param.id : ''}).then(data => {
      ...
      async updateitem (payload) {
        ...
        await axios.post('http://20.189.115.250/api/update-notification', payload).then(data => {
