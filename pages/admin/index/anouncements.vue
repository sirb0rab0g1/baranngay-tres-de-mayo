...
<script>
  ...
  export default {
    ...
    methods: {
      async view (payload) {
        await axios.post('http://20.84.109.153/api/search-announcement', {id: payload.id, title: ''}).then(data => {
          this.showevent = true
      ...
      async searchannouncement () {
        await axios.post('http://20.84.109.153/api/search-announcement', {title: _.isNull(this.search) ? '' : this.search, id: null}).then(data => {
      ...
      async createevent () {
        ...
        this.$set(this.form, 'image', '')
        await axios.post('http://20.84.109.153/api/create-announcement', this.form).then(data => {
          this.getdataimage(data.data)
        })
      },
      async getallannouncements () {
        await axios.get('http://20.84.109.153/api/get-all-announcements').then(data => {
          this.requests = data.data
        })
      },
      async getdataimage (data) {
        ...
        await axios.post('http://20.84.109.153/api/announcement-upload', formData)
        .then(data => {
      ...
      async deleteannouncement (payload) {
        await axios.post('http://20.84.109.153/api/delete-announcement', payload).then(data => {
          this.snackbar = true
